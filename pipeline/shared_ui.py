...
def shared_nav(home_href: str = "/") -> str:
    ...
    return (
        ...
        f'border:1px solid rgba(255,255,255,0.2);border-radius:6px;padding:5px 11px;'
        f'cursor:pointer;font-size:12px;color:rgba(255,255,255,0.6);font-family:inherit;'
        f'transition:all 150ms;"'
        f' onmouseover="this.style.borderColor=\'rgba(255,255,255,0.5)\';this.style.color=\'rgba(255,255,255,0.9)\'"'
        f' onmouseout="this.style.borderColor=\'rgba(255,255,255,0.2)\';this.style.color=\'rgba(255,255,255,0.6)\'">'
        f'{_PALETTE_BTN_SVG}'
        ...
        f'style="font-size:12px;color:rgba(255,255,255,0.5);text-decoration:none;'
        f'border:1px solid rgba(255,255,255,0.12);border-radius:6px;padding:5px 12px;'
        f'white-space:nowrap;transition:all 150ms;"'
        f' onmouseover="this.style.color=\'rgba(255,255,255,0.9)\';this.style.borderColor=\'rgba(255,255,255,0.4)\'"'
        f' onmouseout="this.style.color=\'rgba(255,255,255,0.5)\';this.style.borderColor=\'rgba(255,255,255,0.12)\'">'
        f'청약홈 ↗</a>'
